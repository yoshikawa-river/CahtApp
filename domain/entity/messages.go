...
var MessageWhere = struct {
	...
	ID:        whereHelperuint64{field: "`messages`.`id`"},
	Content:   whereHelperstring{field: "`messages`.`content`"},
	UserID:    whereHelperuint64{field: "`messages`.`user_id`"},
	RoomID:    whereHelperuint64{field: "`messages`.`room_id`"},
...
var (
	messageAllColumns            = []string{"id", "content", "user_id", "room_id", "created_at", "updated_at"}
	messageColumnsWithoutDefault = []string{"content", "user_id", "room_id", "created_at", "updated_at"}
...
func FindMessage(ctx context.Context, exec boil.ContextExecutor, iD uint64, selectCols ...string) (*Message, error) {
	messageObj := &Message{}
...
func (o *Message) Insert(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) error {
	...
	if err != nil {
		return errors.Wrap(err, "entity: unable to populate default values for messages")
	}
...
func (o *Message) Upsert(ctx context.Context, exec boil.ContextExecutor, updateColumns, insertColumns boil.Columns) error {
	...
	if err != nil {
		return errors.Wrap(err, "entity: unable to upsert for messages")
	}
	...
	if err != nil {
		return errors.Wrap(err, "entity: unable to retrieve unique values for messages")
	}
...
func MessageExists(ctx context.Context, exec boil.ContextExecutor, iD uint64) (bool, error) {
	var exists bool
